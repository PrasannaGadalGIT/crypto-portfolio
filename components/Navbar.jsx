      ...
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 md:gap-6">
          <div className="hidden md:flex items-center gap-4 md:gap-6 font-medium text-lg">
            <Link href="/dashboard" className="text-white hover:text-purple-600 transition">
              Dashboard
            </Link>
            <Link href="/lend" className="text-white hover:text-purple-600 transition">
              Lend
            </Link>
            <Link href="/borrow" className="text-white hover:text-purple-600 transition">
              Borrow
            </Link>
