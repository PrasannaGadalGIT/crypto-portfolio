...
export default function LendPage() {
  return (
    <section className="min-h-[calc(100vh-80px)] pt-16 bg-linear-to-b from-gray-950 to-purple-950 text-white px-6 overflow-hidden">
      <div className="max-w-4xl mx-auto text-center">
        {/* Header */}
        <h1 className="text-5xl font-bold mb-6">Lend Your SOL</h1>
        ...
        <div className="bg-black/30 border border-purple-500/20 rounded-2xl p-10 hover:border-purple-500/50 transition">
          ...
          <p className="text-gray-400 mb-6">Current APY: <span className="text-purple-400 font-semibold">6.2%</span></p>
          ...
          <p className="text-gray-400 text-sm">Your earnings will appear here once you start lending.</p>
        </div>
      </div>
    </section>
  );
